  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Back Button */}
        <button
          onClick={() => navigate("/view-our-partners")}
          className="mb-6 inline-flex items-center px-4 py-2 text-blue-600 hover:text-blue-800 font-medium transition-colors"
        >
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Join our network of trusted education partners and help students
            achieve their dreams of studying medicine abroad
          </p>
        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleInputChange("currentStudents", e.target.value)
                      }
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    >
            ...
            {currentStep === 4 && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Expected Students per Year *
                    </label>
                    <select
                      required
                      value={formData.expectedStudents}
                      onChange={(e) =>
                        handleInputChange("expectedStudents", e.target.value)
                      }
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    >
                      <option value="">Select range</option>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleInputChange("marketingBudget", e.target.value)
                      }
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      handleInputChange("whyPartner", e.target.value)
                    }
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    References (Previous Partners/Clients)
                  </label>
                  <textarea
                    rows={3}
                ...
                <div className="space-y-4">
                  <label className="flex items-start">
                    ...
                    <span className="ml-3 text-sm text-gray-700">
                      ...
                      . I understand that this application will be reviewed and
                      I may be contacted for additional information.
                    </span>
                  </label>
                  ...
                  <label className="flex items-start">
                    ...
                    <span className="ml-3 text-sm text-gray-700">
                      ...
                      personal and business information as outlined in the{" "}
                      <a href="#" className="text-blue-600 hover:underline">
                        Privacy Policy
                      </a>
                      . This information will be used solely for partnership
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="text-sm text-blue-800">
                      ...
                      <ul className="list-disc list-inside space-y-1 text-blue-700">
                        ...
                        <li>
                          Interview with our partnership team (if shortlisted)
                        </li>
                        <li>
                          Final decision and partnership agreement signing
                        </li>
                      </ul>
                    </div>
                  </div>
