  ...
  <script type="application/ld+json">
    {
      ...
      "itemListElement": [{
        ...
        "@type": "ListItem",
        "position": 2,
        "name": "Training cum internship program",
        "item": "<?php echo e(route('internships')); ?>"
      }, {
        "@type": "ListItem",
        "position": 3,
        "name": "<?php echo e($internship->title); ?>",
        "item": "<?php echo e(route('internship.detail',['slug' => $internship->slug])); ?>"
      }]
    }
  </script>
        ...
        <div class="col-lg-12 col-md-12">
          <div class="ed_detail_wrap light">
            <ul class="cources_facts_list">
              ...
              <li class="facts-1"><a href="<?php echo e(route('internships')); ?>">Training cum Internship Program</a></li>
              <li class="facts-1"><?php echo e($internship->title); ?></li>
            </ul>
            <div class="ed_header_caption mb-0">
              <h1 class="ed_title mb-0"><?php echo e($internship->heading); ?></h1>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="new-scoll-links scroll-bar scroll-sticky new-stickyadd">
    <div class="container">
      <ul class="links scrollTo vertically-scrollbar">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $internship->contents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
          <li class="<?php echo e($loop->first ? 'active' : ''); ?>">
            <a href="#<?php echo e(slugify($row->tab)); ?>"><?php echo e(ucwords($row->tab)); ?></a>
          </li>
    ...
    <div class="container">
      <div class="row">
            ...
            <div class="edu_wraper">
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $internship->contents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($loop->first): ?>
                  <img data-src="<?php echo e(storage_cdn($internship->og_image_path)); ?>" loading="lazy"
                    alt="<?php echo e($internship->title); ?>" class="img-responsive loading" data-was-processed="true">
        ...
        <div class="col-lg-4 col-md-4">
          ...
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($internships->count() > 0): ?>
            <div class="single_widgets widget_category">
              ...
              <ul>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $internships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                  <li>
                    <a href="<?php echo e(url('internship/' . $row->slug)); ?>">
...
<?php echo $__env->make('front.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\front\internship-detail.blade.php ENDPATH**/ ?>