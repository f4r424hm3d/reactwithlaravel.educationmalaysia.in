          ...
          <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
              <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item"><a href="<?php echo e(url('/admin/exams/')); ?>">Exams</a></li>
...
<?php $component = App\View\Components\TextareaField::resolve(['label' => 'Decription','name' => 'description','id' => 'description','ft' => $ft,'sd' => $sd] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
  ...
  <img src="<?php echo e(storage_url($row->thumbnail_path)); ?>" alt="" height="80" width="80">
<?php else: ?>
  N/A
  <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                              </td> -->
                      <td>
                        ...
                        <a href="<?php echo e(url('admin/' . $page_route . '/' . $exam->id . '/update/' . $row->id)); ?>"
...
<?php echo $__env->make('admin.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\admin\exam-content.blade.php ENDPATH**/ ?>