...
<?php $component = App\View\Components\SelectField::resolve(['label' => 'Select Level','name' => 'level','id' => 'level','ft' => $ft,'sd' => $sd,'list' => $levels,'showv' => 'level','savev' => 'level'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = App\View\Components\TextareaField::resolve(['label' => 'Enter Description','name' => 'content','id' => 'content','ft' => $ft,'sd' => $sd] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
  ...
  <script>
    ...
    $(function() {
      var $content = ClassicEditor.create(document.querySelector('#content'));
...
<?php echo $__env->make('admin.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\admin\course-specialization-level-contents.blade.php ENDPATH**/ ?>