              ...
              <div class="row">
                ...
                <div class="form-group mb-3 col-md-6 col-sm-12">
                  ...
                  <select id="followup_type" name="followup_type" class="form-control ">
                    <option value="">Select</option>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $fuptype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                ...
                <div class="form-group mb-3 col-md-6 col-sm-12">
                  ...
                  <select id="followup_status" name="followup_status" class="form-control ">
                    <option value="">Select</option>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $fupstatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
...
<script>
  $(document).ready(function() {
    $('#leadStatusForm').on('submit', function(event) {
      ...
      //alert(student_id);
      $.ajax({
        url: "<?php echo e(url('common/add-student-follow-up')); ?>",
        method: "GET",
        data: $(this).serialize(),
  ...
  function fetchLastFollowup(id) {
    ...
    if (id != '') {
      $.ajax({
        url: "<?php echo e(url('common/get-last-follow-up')); ?>",
        method: "GET",
        data: {
          student_id: id
        },
...
<?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\common\change-status-model.blade.php ENDPATH**/ ?>