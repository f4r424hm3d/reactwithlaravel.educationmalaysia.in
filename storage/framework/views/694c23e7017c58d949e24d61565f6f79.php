...
<?php $component = App\View\Components\SelectField::resolve(['label' => 'Select Author','name' => 'author_id','id' => 'author_id','ft' => $ft,'sd' => $sd,'list' => $authors,'savev' => 'id','showv' => 'name'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->make('admin.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\admin\page-contents.blade.php ENDPATH**/ ?>