          ...
          <tr>
            <td valign="top" class="content" style="background:white;padding:20px 35px 10px 35px;">
              ...
              <p style="text-align: justify">
                <?php echo e($otp); ?> is your One Time Password (OTP) from <b><?php echo e(config('app.name')); ?></b>. It will expire
                in next
                15 minutes.
                <br>
                <br>
...
<?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\mails\send-otp.blade.php ENDPATH**/ ?>