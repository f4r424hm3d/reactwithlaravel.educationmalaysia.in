<?php $__env->startPush('seo_meta_tag'); ?>
  <?php echo $__env->make('front.layouts.student_page_meta_tag', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopPush(); ?>
        ...
        <div class="col-xl-9 col-lg-8 col-md-12 col-sm-12 mb-4">
          <div class="profile-infos">
            <div class="infoContent mt-0 p-0">
              ...
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($appliedprograms->count() > 0): ?>
                <div class="dashboard_container mt-3">
                  <div class="dashboard_container_body">

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $appliedprograms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        ...
                        <div class="dashboard_single_course_caption p-0">
                          ...
                          <div class="row align-items-center">
                            <div class="col-md-12">
                              <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-6 col-lg-3 mb-3 "><span
                                    class="theme-cl">Deadline:</span>

                                  <span class="duratinss"><?php echo e($row->universityProgram->application_deadline ?? 'N/A'); ?>
                          ...
                          <div class="row">
                            <div class="col-md-12 mt-1">
                              <span class="theme-cl">University :</span> <?php echo e($row->universityProgram->university->name); ?>

                              <a href="javascript:void()" onclick="deleteAppliedProgram('<?php echo e($row->id); ?>')"
                                class="btn btn-sm btn-danger" style="float:right"><span><i
  ...
  <script>
    function deleteAppliedProgram(id) {
      ...
      if (deleteConfirm == true) {
        if (id != '') {
          $.ajax({
            url: "<?php echo e(url('/student/delete-program/')); ?>/" + id,
            method: "GET",
...
<?php echo $__env->make('front.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\front\student\applied-colleges.blade.php ENDPATH**/ ?>