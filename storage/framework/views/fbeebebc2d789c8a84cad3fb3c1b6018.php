  ...
  <div class="image-cover ed_detail_head lg" style="background:url(<?php echo e(storage_cdn('front/')); ?>/assets/img/ub.jpg);"
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center">
        <div class="col-lg-2 col-md-2 col-6"><img data-src="<?php echo e(storage_cdn('front/')); ?>/assets/img/u-logo.jpeg"
        ...
        <li><i class="fa fa-globe"></i><span>World Rank:</span> 114</li-->
            ...
            <!--a href="<?php echo e(url('/sign-up/?return_to=')); ?>" class="btn btn-white-t-theme mr-3"><i class="ti-download mr-1"></i> Download Brochure</a>
        <a href="<?php echo e(url('/sign-up/?return_to=')); ?>" class="btn btn-white-theme mr-3"><i class="ti-user mr-1"></i> Get free counselling</a-->
    ...
    <div class="container">
      ...
      <div class="edu_wraper mt-3">
            ...
            <div class="show-more-box-country">
              <div class="text show-more-height">
                <div class="author pt-0">
                  <div class="img-div"><img data-src="<?php echo e(storage_cdn('front/')); ?>/assets/img/user-3.jpg"
                      alt=""><i class="fa fa-check-circle"></i></div>
                  <div class="cont-div">
        ...
        <p class="fw-600">Batch of 2022 | Bechlor of Information Technology (Hons) Data Analytics</p-->
                ...
                <h5 class="mt-4 mb-0 heading-fonts">College Infrastructure</h5>
                <p class="dummy-lorems">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                  Ipsum has been the
                ...
                <h5 class="mt-4 mb-0 heading-fonts">Faculty</h5>
                <p class="dummy-lorems">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                  Ipsum has been the
                  industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and
                  scrambled it to make a type specimen book.</p>

                <h5 class="mt-4 mb-0 heading-fonts">Placement</h5>
                <p class="dummy-lorems">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                  Ipsum has been the
                  industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and
                  scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap
                ...
                <h5 class="mt-4 mb-0 heading-fonts">Hostel Life</h5>
                <p class="dummy-lorems">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                  Ipsum has been the
                  industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and
                  scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap
                ...
                <h5 class="mt-4 mb-0 heading-fonts">Enything Else</h5>
                <p class="dummy-lorems">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                  Ipsum has been the
                  industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and
                  scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap
...
<?php echo $__env->make('front.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\front\reviews.blade.php ENDPATH**/ ?>