...
<?php $__env->startSection('main-section'); ?>
  <div class="image-cover half_banner"
    style="background:#0b2248 url(https://www.educationmalaysia.in/front/assets/img/partner-banner.jpg) no-repeat;">
    <div class="container">
      <!-- Type -->
      <div class="row">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-5">
            <div class="list_facts_wrap_img ser image-services"><img
                data-src="https://www.educationmalaysia.in/front/assets/img/partners-service.png" class="img-fluid"
                alt="">
            </div>
          </div>
        </div>
  ...
  <section class="strengths core-section  "
    style="background:url(https://www.educationmalaysia.in/front/assets/img/testimonial.png)">
    <div class="container">
      <div class="row">
    ...
    <div class="container">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-5">
            <div class="list_facts_wrap_img"><img
                data-src="https://www.educationmalaysia.in/front/assets/img/student2.png" class="img-fluid"
                alt="">
            </div>
          </div>
        </div>
      ...
      <div class="edu_cat_2 cat-4 pl-4 pr-4">
        <div class="row align-items-center">
          <div class="col-lg-5">
            <div class="list_facts_wrap_img"><img
                data-src="https://www.educationmalaysia.in/front/assets/img/franchise.png" class="img-fluid"
                alt="">
            </div>
          </div>
          ...
          <div class="col-lg-7">
            <div class="about-short">
              ...
              <p class="mb-4">At Education Malaysia Education, we understand the unique needs and challenges faced by
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-7">
            <div class="about-short">
              ...
              <p class="mb-4">At Education Malaysia Education, we take pride in being a bridge between universities
          ...
          <div class="col-lg-5">
            <div class="list_facts_wrap_img"><img
                data-src="https://www.educationmalaysia.in/front/assets/img/university2.png" class="img-fluid"
                alt="">
            </div>
          </div>
  ...
  <section class="bg-light lets-helps">
    <div class="container">
      ...
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($destinations->count() > 0): ?>
          ...
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $destinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
            <div class="singles_items">
              <div class="card shadow-0 mb-0">
                <img data-src="<?php echo e(storage_url($row->thumbnail_path)); ?>" class="img-fluid"
                  alt="<?php echo e($row->destination_name); ?>">
                <div class="card-header bg-light border-0 pl-4 pr-4">
                  <h4 class="text-center" style="font-size:15px; font-weight:600;">Study in <?php echo e($row->destination_name); ?>

                  </h4>
                  <a href="<?php echo e(url($row->destination_slug)); ?>" class="btn btn_apply w-100" style="height:40px">View
                    Details</a>
                </div>
              </div>
            </div>
      ...
      <div class="row justify-content-center mt-4">
        <a href="<?php echo e(url('cities')); ?>" class="btn btn-modern float-none">View all Destinations<span><i
              class="fa fa-angle-right"></i></span></a>
      </div>
    </div>
  </section>
  ...
  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($blogs->count() > 0): ?>
    <section class="min-sec bg-light">
      <div class="container">
                        ...
                        <div class="singles_items">
                          <div class="education_block_grid style_2">
                            <div class="education_block_thumb n-shadow">
                              <a href="<?php echo e(url($row->slug)); ?>"><img data-src="<?php echo e(storage_url($row->thumbnail_path)); ?>"
                                  class="article-img" alt="<?php echo e($row->title); ?>"></a>
                              <div class="cources_price"><?php echo e($row->getCategory->category_name); ?></div>
                            </div>
                            <div class="education_block_body">
                              <h4 class="bl-title"><a href="<?php echo e(url($row->slug)); ?>"><?php echo e($row->title); ?></a></h4>
                            </div>
                            <div class="cources_info_style3">
                              <ul>
                                <li><i class="ti-calendar mr-2"></i><?php echo e(getFormattedDate($row->created_at, 'd M, Y')); ?>
        ...
        <div class="row justify-content-center">
          <a href="<?php echo e(url('/articles')); ?>" class="btn btn-modern float-none">View all Articals<span><i
                class="fa fa-angle-right"></i></span></a>
        </div>
      </div>
    </section>
...
<?php echo $__env->make('front.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\front\partner-services.blade.php ENDPATH**/ ?>