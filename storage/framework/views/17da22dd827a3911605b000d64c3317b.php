        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width:100%;border-collapse:collapse;">
          <tr>
            <td valign="top" align="center" class="masthead"
              ...
              <h1 style="font-size:32px;margin:0 auto;max-width:90%;line-height:1.25;">
                <a href="<?php echo e(url('/')); ?>" target="_blank" style="text-decoration:none;color:#ffffff;"><?php echo e(config('app.name')); ?></a>
          ...
          <tr>
            <td valign="top" class="content" style="background:white;padding:25px;">
              ...
              <button class="pink-btn"><a href="<?php echo e($login_link); ?>">Log in</a></button>
              <button class="blue-btn"><a href="<?php echo e($reset_password_link); ?>">Reset your password</a></button>
            </td>
          </tr>
          <tr>
...
</html><?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\mails\admin\forget-password-link.blade.php ENDPATH**/ ?>