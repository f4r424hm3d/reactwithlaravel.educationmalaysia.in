...
<?php $component = App\View\Components\NumberInput::resolve(['type' => 'number','label' => 'Position','name' => 'position','id' => 'position','ft' => $ft,'sd' => $sd] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = App\View\Components\ContentViewModal::resolve(['row' => $row,'field' => 'description','title' => 'Description'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = App\View\Components\EditButton::resolve(['url' => url('admin/' . $page_route . '/' . $university->id . '/update/' . $row->id)] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
  ...
  <script>
    ...
    function setPosition() {
      //alert('Hello');
      var university_id = '<?php echo e($university_id); ?>';
      return new Promise(function(resolve, reject) {
        setTimeout(() => {
          $.ajax({
            url: "<?php echo e(aurl($page_route . '/get-position')); ?>",
            method: "GET",
            data: {
...
<?php echo $__env->make('admin.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\admin\university-rankings.blade.php ENDPATH**/ ?>