          ...
          <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 mb-4">
            <div class="education_block_grid style_2 all-cards">
              <div class="education_block_thumb n-shadow fix-sizes">
                <img data-src="<?php echo e(storage_url($row->imgpath)); ?>" class="fix-sizes" alt="<?php echo e($row->page_name); ?>">
                <div class="cources_price"><?php echo e($row->page_name); ?></div>
              </div>
              <div class="education_block_body title-size">
                <h4 class="bl-title card-title"><?php echo e($row->headline); ?></h4>
              </div>
              <div class="education_block_footer align-items-center p">
                <a href="<?php echo e(route('exam.detail', ['uri' => $row->uri])); ?>" class="btn-regi">View Details</a>
              </div>
            </div>
          </div>
...
<?php echo $__env->make('front.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\front\exams.blade.php ENDPATH**/ ?>