...
<?php $__env->startSection('main-section'); ?>
  ...
  <div class="image-cover half_banner"
    style="background:#0b2248 url(https://www.educationmalaysia.in/front/assets/img/students-banner.jpg) no-repeat;">
    <div class="container">
      <!-- Type -->
      <div class="row">
    ...
    <div class="container">
      ...
      <div class="edu_cat_2 cat-3 pl-4 pr-4">
        <div class="row align-items-center">
          ...
          <div class="col-lg-5">
            <div class="list_facts_wrap_img"><img
                data-src="https://www.educationmalaysia.in/front/assets/img/partners.png" class="img-fluid"
                alt="">
            </div>
          </div>
...
<?php echo $__env->make('front.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\front\student-services.blade.php ENDPATH**/ ?>