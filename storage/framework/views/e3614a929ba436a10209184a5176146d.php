...
<script>
  function editInfoModelFunc(id) {
    ...
    //alert(id);
    $.ajax({
      url: "<?php echo e(aurl('leads/get-quick-info')); ?>",
      method: "GET",
      data: {
        id: id
      },
  ...
  $(document).ready(function() {
    $('#editInfoForm').on('submit', function(event) {
      ...
      $.ajax({
        url: "<?php echo e(aurl('leads/update-quick-info/')); ?>/",
        method: "get",
        data: {
          id: id,
          name: name,
  ...
  function fetchLastUpdatedRecord(id) {
    ...
    if (id != '') {
      $.ajax({
        url: "<?php echo e(aurl('leads/fetch-last-updated-record')); ?>/" + id,
        method: "get",
...
<?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\admin\update-student-info.blade.php ENDPATH**/ ?>