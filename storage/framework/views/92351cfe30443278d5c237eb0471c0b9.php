      ...
      <div class="row">
        <div class="col-12">
          <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18"><?php echo e($page_title); ?> <span class="text-danger">(<?php echo e($article->title); ?>)</span>
            </h4>
            <div class="page-title-right">
              <ol class="breadcrumb m-0">
                <li class="breadcrumb-item"><a href="<?php echo e(url('/admin/')); ?>"><i class="mdi mdi-home-outline"></i></a></li>
                <li class="breadcrumb-item"><a href="<?php echo e(url('/admin/destinations/')); ?>">Destination</a></li>
                <li class="breadcrumb-item"><a href="<?php echo e(url('/admin/destination-articles/')); ?>">Article</a>
                </li>
          ...
          <div class="card">
            ...
            <div class="card-body <?php echo e($ft == 'edit' ? '' : 'hide-this'); ?>" id="tblCDiv">
              <form id="<?php echo e($ft == 'add' ? 'dataForm' : 'editForm'); ?>" <?php echo e($ft == 'edit' ? 'action=' . $url : ''); ?>
                ...
                <?php echo csrf_field(); ?>
                <input type="hidden" name="destination_article_id" id="destination_article_id"
...
<?php endif; ?>
  ...
  <script>
    ...
    function getData(page) {
      ...
      var destination_article_id = '<?php echo e($article->id); ?>';
      //alert(page+destination_article_id);
...
<?php echo $__env->make('admin.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\admin\destination-article-faqs.blade.php ENDPATH**/ ?>