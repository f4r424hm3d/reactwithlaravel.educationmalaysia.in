    ...
    <div class="row">
              ...
              <div class="scrlbar">
                <div class="card-body pl-4 pr-4 pb-2">
                  <ul class="no-ul-list mb-3">
                    ...
                    <li>
                      <input id="level<?php echo e($row->getLevel->id); ?>" class="checkbox-custom" name="institute_type"
                        type="checkbox" onclick="<?php echo  session()->get('USF_level')==$row->getLevel->id ? "
                        removeFilter('USF_level')":"ApplyLevelFilter('".$row->getLevel->id."')" ?>" <?php echo e(session()->get('USF_level')==$row->getLevel->id?'checked':''); ?> >
                      <label for="level<?php echo e($row->getLevel->id); ?>" class="checkbox-custom-label"><?php echo e($row->getLevel->level); ?></label>
                    </li>
      ...
      <div class="col-lg-9 col-md-12 col-12">
        ...
        <div class="filter-block">
          <h4 class="mb-0"><span class="theme-cl"><?php echo e($total); ?></span> Scholarship offered by <span class="theme-cl">
          ...
          <div class="portal-filter">
            ...
            <ul>
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session()->has('USF_level')): ?>
              <li><a onclick="removeFilter('USF_level')" href="javascript:void(0)"><?php echo e($filter_level->level); ?><span
                    class="cross">×</span></a></li>
              <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </ul>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session()->has('USF_level') || session()->has('USF_course_category')
            ...
            <div class="dashboard_single_course pl-4 pr-4">
              <div class="dashboard_single_course_caption pl-0">
                <div class="dashboard_single_course_head">
                  <div class="dashboard_single_course_head_flex">
                    <h4 class="dashboard_course_title"><a
                        href="<?php echo e(url($university->slug.'/scholarship/'.$row->scholarship_slug)); ?>"><?php echo e($row->scholarship_name); ?></a>
                    </h4>
                  </div>
                </div>
                <div class="row align-items-center">
                  <div class="col-md-9">
                    <div class="row">
                      <div class="col-md-3 col-6 mt-1 mb-1">Amount:<br><strong><?php echo e($row->amount); ?></strong></div>
                      <div class="col-md-3 col-6 mt-1 mb-1">Level:<br><strong><?php echo e($row->getLevel->level); ?></strong></div>
                      <div class="col-md-3 col-6 mt-1 mb-1">No of Scholarship:<br><strong>
                          <?php echo e($row->number_of_scholarship); ?>

                        </strong></div>
                      <div class="col-md-3 col-6 mt-1 mb-1">international Student Eligible:<br>
                        <strong><?php echo e($row->international_student_eligible); ?></strong>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-3">
                    <a href="<?php echo e(url($university->slug.'/scholarship/'.$row->scholarship_slug)); ?>"
...
<script>
  function ApplyLevelFilter(val) {
    //alert(val);
    $.ajax({
      url: "<?php echo e(url('university-scholarship-list/level')); ?>",
      method: "GET",
      data: {
        level_id: val
      },
  ...
  function ApplyCategoryFilter(val) {
    //alert(val);
    $.ajax({
      url: "<?php echo e(url('university-scholarship-list/category')); ?>",
      method: "GET",
      data: {
  ...
  function ApplySpecializationFilter(val) {
    //alert(val);
    $.ajax({
      url: "<?php echo e(url('university-scholarship-list/specialization')); ?>",
      method: "GET",
      data: {
  ...
  function ApplyFilter(col,val) {
    //alert(`${col} , ${val}`);
    $.ajax({
      url: "<?php echo e(url('university-scholarship-list/apply-filter')); ?>",
      method: "GET",
      data: {
        col: col,
        val: val,
  ...
  function removeFilter(a) {
    ...
    if (a != "") {
      $.ajax({
        url: "<?php echo e(url('university-scholarship-list/remove-filter')); ?>",
        method: "GET",
        data: {
          value: a
        },
        success: function(b) {
          window.open("<?php echo e(url($university->slug.'/scholarship/')); ?>", '_SELF');
        }
      })
    }
  }
  function removeAllFilter() {
    $.ajax({
      url: "<?php echo e(url('university-scholarship-list/remove-all-filter')); ?>",
      method: "GET",
      success: function(b) {
        window.open("<?php echo e(url($university->slug.'/scholarship/')); ?>", '_SELF');
      }
...
<?php echo $__env->make('front.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\front\university-scholarship-list.blade.php ENDPATH**/ ?>