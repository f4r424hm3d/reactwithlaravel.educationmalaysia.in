      ...
      <div class="row">
        ...
        <div class="col-xl-3 col-lg-4 col-md-12 col-sm-12 mb-4">
          <div class="dashboard-navbar">
            <div class="d-user-avater"><img data-src="<?php echo e(storage_cdn('front/')); ?>/assets/img/user.jpg"
            ...
            <div class="d-navigation">
              <ul id="side-menu">
                <li class="active"><a href="student-profile.html"><i class="ti-user"></i>My Profile</a></li>
    ...
    <div class="notiBlank"><h3>Registration Date: January 2nd, 2022</h3></div-->
          ...
          <div class="infoContent mt-3" id="PerInfo">
            <div class="row">
              ...
              <div class="col-md-2">
                <label>Marital Status <i class="fa fa-info-circle"
                    title="We collect your passport information for identity verification purposes, your school or program of interest may require this information to process your application. If applicable, it may also be used for processing your visa."></i>
                  <span class="red">*</span></label>
                <select name="">
              ...
              <div class="col-md-12" style="margin-top:40px">
                <h2>Address Detail <span><svg width="24" height="24" fill="none"
                      xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                      <path fill-rule="evenodd" clip-rule="evenodd"
                        d="M11 17h2v-6h-2v6zm1-15C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zM11 9h2V7h-2v2z">
                      </path>
                    </svg> Please make sure to enter the student's residential address. Organization address will not be
                    accepted.</span></h2>
              </div>
              <div class="col-md-8">
          ...
          <div class="infoContent" id="EduSummary">
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <label class="checkRyt" style="margin-top:10px!important">Graduated from most recent school <input
                    type="checkbox" value="3"><span class="checkmark"></span></label>
              </div>
              <div class="col-md-12"><button class="saveBtn">Save</button><button class="cancelBtn">Cancel</button>
              </div>
            </div>
          ...
          <div class="infoContent" id="SchAtd">
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <div class="d-flex">
                  <label class="checkCircle" style="margin-top:10px!important">Yes<input type="radio"
                      checked="checked" name="radio"><span class="checkmark"></span></label>
                  <label class="checkCircle ml-3" style="margin-top:10px!important">No<input type="radio"
                      name="radio"><span class="checkmark"></span></label>
                </div>
              </div>
              <div class="clearfix"></div>
              <div class="col-md-4">
                <label>Graduation Date <span class="red">*</span> <svg width="24" height="24" fill="none"
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                    style="fill:#323847; position: absolute; margin-left:4px;">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                      d="M11 17h2v-6h-2v6zm1-15C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zM11 9h2V7h-2v2z">
                    </path>
                  </svg></label>
              ...
              <div class="col-md-4">
                ...
                <label class="checkRyt" style="margin-top:0px!important">I have the physical certificate for this degree
                  <input type="checkbox" value="3"><span class="checkmark"></span></label>
              </div>
              <div class="clearfix"></div>
              <div class="col-md-12" style="margin-top:40px">
            ...
            <div class="row SchAtdResult">
              ...
              <div class="col-md-8 light">
                <h3><svg role="img" width="18" height="18" fill="none"
                  ...
                  </svg><b>Graduated from Institution</b> January 2, 2021</h3>
                <h3><svg role="img" width="18" height="18" fill="none"
                    xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="fill:#58BE91; margin-right:5px">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                      d="M19.707 6.293a1 1 0 010 1.414L9 18.414l-4.707-4.707a1 1 0 111.414-1.414L9 15.586l9.293-9.293a1 1 0 011.414 0z">
                    </path>
                  </svg><b>Level:</b> 3-Year Bachelors Degree</h3>
              ...
              <div class="col-md-12"><button class="saveBtn">Expand</button><button class="deleteBtn">Delete</button>
              </div>
            ...
            <div class="row SchAtdResult">
              ...
              <div class="col-md-12"><button class="schAtdBtn">Add Attended School<i
                    class="fa fa-plus css-1a2afmv"></i></button></div>
          ...
          <div class="infoContent" id="TestScores">
            <div class="row">
              ...
              <div class="col-md-12">
                <p style="font-size:16px; margin-top:15px">Note: You will be able to apply for conditional admission by
                  enrolling in an ESL program if the academic program does not accept delayed submission of English
                  Language Proficiency scores.</p>
              </div>
              <div class="col-md-12"><button class="saveBtn">Save</button><button class="cancelBtn">Cancel</button>
              </div>
            </div>
          ...
          <div class="infoContent" id="BackInfo">
            <div class="row">
              ...
              <div class="col-md-6">
                <label>Have you been refused a visa from Canada, the USA, the United Kingdom, New Zealand or Australia? <i
