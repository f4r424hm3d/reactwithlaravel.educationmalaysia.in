          ...
          <tr>
            <td valign="top" align="center" class="masthead" style="padding:20px 0;background:#03618c;color:white;">
              <h1 style="font-size:32px;margin:0 auto;max-width:90%;line-height:1.25;">
                <a href="<?php echo e(url('/')); ?>" target="_blank" style="text-decoration:none;color:#ffffff;">
          ...
          <tr>
            <td valign="top" class="content" style="background:white;padding:20px 35px 10px 35px;">
              ...
              <p style="text-align: justify">
                Your account has been created on <a href="<?php echo e(url('/')); ?>/">IELTS
                  Practice</a>. Login
                details are as follows :
                <br>
                Username / UserId : <b><?php echo e($username); ?></b><br>
                Email : <b><?php echo e($email); ?></b><br>
                Password : <b><?php echo e($password); ?></b><br>
                <br>
                Click <a href="<?php echo e(url('/')); ?>/counsellor/login">here</a> to login.
                <br>
                <br>
                <br>
                In case of any queries, feel free to contact us at <span
                  style="color: #fcb709;font-weight:bold">info@educationmalaysia.in</span>
              </p>
              <hr>
              <p style="text-align: justify">
...
<?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\mails\employee-account-create.blade.php ENDPATH**/ ?>