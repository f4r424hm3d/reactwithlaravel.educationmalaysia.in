...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                  ...
                  <div class="col-md-12 col-sm-12">
                    <div class="form-group mb-3">
                      ...
                      <textarea name="meta_description" id="description" class="form-control" cols="30" rows="5"><?php echo e($ft == 'edit' ? $sd->meta_description : old('meta_description')); ?></textarea>
...
<?php echo $__env->make('admin.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\admin\static-page-seos.blade.php ENDPATH**/ ?>