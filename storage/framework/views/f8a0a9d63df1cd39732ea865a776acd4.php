          ...
          <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">
              <?php echo e($page_title); ?> <span class="text-danger">
                (<?php echo e($jobtab->getPage->page_name); ?> - <?php echo e($jobtab->tab_name); ?>)
              </span>
            </h4>
            <div class="page-title-right">
              <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item"><a href="<?php echo e(url('/admin/job-page-tabs/' . $jobtab->getPage->id)); ?>">Job Page
                    Tabs</a></li>
          ...
          <div class="card">
            ...
            <div class="card-body <?php echo e($ft == 'edit' ? '' : 'hide-thi'); ?>" id="tblCDiv">
              <form id="<?php echo e($ft == 'add' ? 'dataForm' : 'editForm'); ?>" <?php echo e($ft == 'edit' ? 'action=' . $url : ''); ?>
                ...
                <?php echo csrf_field(); ?>
                <input type="hidden" name="tab_id" id="tab_id" value="<?php echo e($jobtab->id); ?>">
                <div class="row">
...
<?php endif; ?>
  ...
  <script>
    ...
    function getData(page) {
      ...
      var tab_id = '<?php echo e($jobtab->id); ?>';
      //alert(page+tab_id);
...
<?php echo $__env->make('admin.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\admin\job-page-tab-contents.blade.php ENDPATH**/ ?>