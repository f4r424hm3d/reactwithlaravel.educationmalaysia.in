...
<?php $component = App\View\Components\ImportForm::resolve(['pageRoute' => $page_route,'fileName' => 'malaysia-application-import-template'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
                  ...
                  <div class="col-md-6 col-sm-12 mb-3">
                    <div class="form-group">
                      ...
                      <input name="search" id="search" type="text" class="form-control"
                        placeholder="Search by Category" value="<?php echo e($_GET['search'] ?? ''); ?>" required>
                    ...
                    <div class="col-md-3 col-sm-12 mb-3">
                      <div class="form-group">
                        ...
                        <select name="category" id="category" class="form-control js-example-basic-singl">
                          ...
                          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $filterCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <option value="<?php echo e($row->id); ?>"
                              <?php echo e(isset($_GET['category']) && $_GET['category'] == $row->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\admin\malaysia-applications.blade.php ENDPATH**/ ?>