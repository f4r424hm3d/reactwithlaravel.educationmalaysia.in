...
<div class="single_widgets widget_category">
  ...
  <div class="row align-items-center booking p-0">
    <form action="<?php echo e(route('stream.inquiry')); ?>" method="post" class="p-3" id="enquiry-form">
      <?php echo csrf_field(); ?>
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Request::segment(1) == 'specialization'): ?>
        <input type="hidden" name="source" value="Education Malaysia - Specialization Page">
      <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Request::segment(1) == 'course'): ?>
      ...
      <div class="row">
        <div class="col-12">
          <div class="form-group">
            ...
            <select class="form-control" name="nationality" id="s-nationality">
...
<?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\front\forms\category-specialization-form.blade.php ENDPATH**/ ?>