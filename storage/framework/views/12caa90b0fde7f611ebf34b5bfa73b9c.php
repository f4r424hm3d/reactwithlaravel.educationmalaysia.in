        ...
        <div class="col-12">
          <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18"><?php echo e($page_title); ?> <span
                class="text-danger">(<?php echo e($destination->destination_name); ?>)</span>
            </h4>
          ...
          <div class="card">
            ...
            <div class="card-body <?php echo e($ft == 'edit' ? '' : 'hide-this'); ?>" id="tblCDiv">
              <form id="<?php echo e($ft == 'add' ? 'dataForm' : 'editForm'); ?>" <?php echo e($ft == 'edit' ? 'action=' . $url : ''); ?>
                ...
                <?php echo csrf_field(); ?>
                <input type="hidden" name="destination_id" id="destination_id" value="<?php echo e($destination->id); ?>">
                <div class="row">
...
<?php endif; ?>
  ...
  <script>
    ...
    function getData(page) {
      ...
      var destination_id = '<?php echo e($destination->id); ?>';
      //alert(page+destination_id);
...
<?php echo $__env->make('admin.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\admin\destination-faqs.blade.php ENDPATH**/ ?>