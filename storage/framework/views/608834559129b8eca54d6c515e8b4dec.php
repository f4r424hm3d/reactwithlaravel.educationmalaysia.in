  ...
  <section class="bg-light">
    <div class="container">
      ...
      <div class="sec-heading center">
        <h2>Job Openings in <span class="theme-cl1">Education Malaysia</span></h2>
      </div>
        ...
        <div class="col-md-12">
          <div id="accordionExample" class="accordion shadow circullum">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
              <div class="card mb-3">
                <div id="headingOne<?php echo e($row->id); ?>" class="card-header bg-white shadow-sm border-0">
                  <h6 class="mb-0 accordion_title">
                    <a href="#" data-toggle="collapse" data-target="#collapseOne<?php echo e($row->id); ?>"
                      aria-expanded="false" aria-controls="collapseOne<?php echo e($row->id); ?>"
                ...
                <div id="collapseOne<?php echo e($row->id); ?>" aria-labelledby="headingOne<?php echo e($row->id); ?>"
                    ...
                    <div class="row">
                      <div class="col-lg-12 col-md-12 col-sm-12 p-0">
                        <div class="bg-light rounded p-4">
                          <p>
                            <strong>No. of Position :</strong> <?php echo e($row->no_of_position); ?> &nbsp; &nbsp; &nbsp;
                            <strong>Experience :</strong> <?php echo e($row->experience); ?>

                          </p>
                          <p>
                            <strong>Location :</strong> <?php echo e($row->location); ?> &nbsp; &nbsp; &nbsp;
                            <strong>Job Type :</strong> <?php echo e($row->job_type); ?>
        ...
        <div class="col-lg-8 col-md-7">
          <div class="prc_wrap bg-light">
            <div class="prc_wrap-body">
              <form action="<?php echo e(url('career/apply')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <select name="experience" id="experience" class="form-control b-0 pl-0 bg-white"
                          ...
                          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $experienceList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <option value="<?php echo e($exp); ?>" <?php echo e(old('experience') == $exp ? 'Selected' : ''); ?>>
                              <?php echo e($exp); ?></option>
                          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </select>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <select name="position" class="form-control b-0 pl-0 bg-white"
                          ...
                          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <option value="<?php echo e($row->id); ?>" <?php echo e(old('position') == $row->id ? 'Selected' : ''); ?>>
                              <?php echo e($row->designation); ?></option>
                          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </select>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group input-group-merge">
                        ...
                        <textarea name="message" id="message" type="text" class="form-control  b-0 pl-0"
                          placeholder="Enter your message here" style="height:100px; padding-top:17px"><?php echo e(old('message')); ?></textarea>
          ...
          <div class="prc_wrap">
            ...
            <div class="prc_wrap-body">
              <div class="contact-info">
                <p>Lead your professional career with Education Malaysia. Drop us a email.</p>

                <div class="cn-info-detail">
                  <div class="cn-info-content">
                    <h4 class="cn-info-title"><i class="ti-email mr-1 theme-cl1"></i> career@educationmalaysia.in
                    </h4>
                  </div>
                </div>
...
<?php echo $__env->make('front.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\front\career.blade.php ENDPATH**/ ?>