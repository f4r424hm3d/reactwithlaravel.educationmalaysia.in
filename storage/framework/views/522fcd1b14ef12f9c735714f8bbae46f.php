...
<?php $__env->startSection('main-section'); ?>
  ...
  <div class="image-cover half_banner"
    style="background:#0b2248 url(https://www.educationmalaysia.in/front/assets/img/banner-1.jpg) no-repeat;">
    <div class="container">
      <!-- Type -->
      <div class="row">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-5">
            <div class="list_facts_wrap_img ser image-services"><img
                data-src="https://www.educationmalaysia.in/front/assets/img/franchises-service.png" class="img-fluid"
                alt="">
            </div>
          </div>
        </div>
...
<?php echo $__env->make('front.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\front\franchise-services.blade.php ENDPATH**/ ?>