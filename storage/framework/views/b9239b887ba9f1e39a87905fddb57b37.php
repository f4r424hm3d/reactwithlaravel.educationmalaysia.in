            ...
            <div class="row justify-content-center">
              <div class="col-md-5 text-center mt-3">
                <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                  ...
                  <ellipse cx="408.16" cy="837.18" rx="111.53" ry="14.52" fill="#0a4191" opacity="0.1">
                  </ellipse>
                  <g data-name="floor flowers">
                    <ellipse cx="182.88" cy="836.06" rx="33.88" ry="5.8" fill="#0a4191" opacity="0.1">
                    </ellipse>
                    <path
                    ...
                    <path
                      ...
                      fill="#0a4191"></path>
                    <ellipse cx="636.58" cy="852.02" rx="29.92" ry="5.06" fill="#0a4191"
                      opacity="0.1"></ellipse>
                    <path
                      ...
                      fill="#0a4191"></path>
                    <ellipse cx="575.21" cy="837.35" rx="16.87" ry="2.85" fill="#0a4191"
                      opacity="0.1"></ellipse>
                    <path
                      ...
                      fill="#0a4191"></path>
                    <ellipse cx="617.19" cy="806.29" rx="20.37" ry="3.44" fill="#0a4191"
                      opacity="0.1"></ellipse>
                  </g>
                  <g data-name="browser">
                  ...
                  <g data-name="boxes">
                    <path fill="#0a4191" d="M380.95 177.32h156.5v98.34h-156.5z"></path>
                  ...
                  <g data-name="leaves" fill="#0a4191">
                    <path
...
<?php echo $__env->make('front.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\front\pending-application.blade.php ENDPATH**/ ?>