          ...
          <tr>
            <td valign="top" class="content" style="background:white;padding:25px;">
              ...
              <ul>
                ...
                <li>Experience : <?php echo e($experience); ?></li>
                <li>Position : <?php echo e($position); ?></li>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($inquiry_message): ?>
                  <li>Message : <?php echo e($inquiry_message); ?></li>
...
<?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\mails\job-application-mail-to-team.blade.php ENDPATH**/ ?>