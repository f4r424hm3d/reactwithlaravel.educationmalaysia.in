                ...
                <div class="row">
                  <div class="col-md-4 col-sm-12 mb-3">
                    <div class="form-group">
                      <label>Enter Follow-UP Type</label>
                      <input name="followup_type" type="text" class="form-control" placeholder="Enter Follow-UP type"
                        value="<?php echo e($ft == 'edit' ? $sd->followup_type : old('followup_type')); ?>">
                      <span class="text-danger">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['followup_type'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <tbody>
                  ...
                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <tr id="row<?php echo e($row->id); ?>">
                      <td><?php echo e($i); ?></td>
                      <td><?php echo e($row->followup_type); ?></td>
                      <td>
                        ...
                        <a href="<?php echo e(url('admin/follow-up-type/update/' . $row->id)); ?>"
  ...
  <script>
    function DeleteAjax(id) {
      ...
      if (cd == true) {
        $.ajax({
          url: "<?php echo e(url('admin/follow-up-type/delete')); ?>" + "/" + id,
...
<?php echo $__env->make('admin.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\admin\follow-up-type.blade.php ENDPATH**/ ?>