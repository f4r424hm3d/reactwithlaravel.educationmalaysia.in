<div class="form-group">
  ...
  <input name="<?php echo e($name); ?>" id="<?php echo e($id); ?>" type="<?php echo e($type); ?>" class="form-control"
    placeholder="<?php echo e($label); ?>" value="<?php echo e($ft == 'edit' ? $sd->$name : old($name)); ?>"
    <?php if($max !== null): ?> max="<?php echo e($max); ?>" <?php endif; ?>
    <?php if($min !== null): ?> min="<?php echo e($min); ?>" <?php endif; ?>
    <?php if($step !== null): ?> step="<?php echo e($step); ?>" <?php endif; ?> <?php echo e($required); ?>>
...
<?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\components\number-input.blade.php ENDPATH**/ ?>