          ...
          <div class="card">
            <div class="card-body p-4">
              <div class="row">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $university->photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                  <div class="col-lg-4 col-md-4 col-sm-4 col-6">
                    <div class="course_overlay_cat">
                      <div class="course_overlay_cat_thumb">
                        <a href="<?php echo e(storage_url($row->photo_path)); ?>" class="fancybox" data-fancybox="gallery"
                          data-caption="Image title type here">
                          <img data-src="<?php echo e(storage_url($row->photo_path)); ?>" class="img-fluid" alt="<?php echo e($row->title); ?>">
                        </a>
                      </div>
                    </div>
                  </div>
...
<?php echo $__env->make('front.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\front\university-gallery.blade.php ENDPATH**/ ?>