      ...
      <div class="row">
        <div class="col-12">
          <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18"><?php echo e($page_title); ?> [<?php echo e($program->course_name); ?> ,
              <?php echo e($program->university->name); ?>]</h4>

            <div class="page-title-right">
              <ol class="breadcrumb m-0">
                <li class="breadcrumb-item"><a href="<?php echo e(url('/admin/')); ?>"><i class="mdi mdi-home-outline"></i></a></li>
                <li class="breadcrumb-item"><a href="<?php echo e(url('/admin/university')); ?>">Universities</a>
                </li>
                <li class="breadcrumb-item"><a
                    href="<?php echo e(url('/admin/university-programs/' . $university->id)); ?>">Programs</a>
                </li>
          ...
          <div class="card">
            ...
            <div class="card-body" id="tblCDiv">
              <form id="<?php echo e($ft == 'add' ? 'dataForm' : 'editForm'); ?>" <?php echo e($ft == 'edit' ? 'action=' . $url : ''); ?>
                ...
                <?php echo csrf_field(); ?>
                <input type="hidden" name="c_id" value="<?php echo e($c_id); ?>">
                <div class="row">
...
<?php $component = App\View\Components\InputField::resolve(['type' => 'text','label' => 'Enter Tab Title','name' => 'tab_title','id' => 'tab_title','ft' => $ft,'sd' => $sd] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->make('admin.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\admin\university-program-contents.blade.php ENDPATH**/ ?>