          ...
          <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
              <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item"><a href="<?php echo e(url('/admin/blogs')); ?>">Blog</a></li>
...
<?php $component = App\View\Components\SelectField::resolve(['label' => 'Select Parent Title','name' => 'parent_id','id' => 'parent_id','ft' => $ft,'sd' => $sd,'list' => $parentContents,'showv' => 'title','savev' => 'id'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
  ...
  <script>
    ...
    function getData(page) {
      ...
      var blog_id = '<?php echo e($blog_id); ?>';
      var ft = '<?php echo e($ft); ?>';
    ...
    function getParentHeadings() {
      ...
      return new Promise(function(resolve, reject) {
        setTimeout(() => {
          $.ajax({
            url: "<?php echo e(aurl($page_route . '/get-parent-headings')); ?>",
            method: "GET",
            data: {
              blog_id: blog_id,
            },
...
<?php echo $__env->make('admin.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\admin\blog-content.blade.php ENDPATH**/ ?>