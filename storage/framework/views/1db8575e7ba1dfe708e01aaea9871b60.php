...
<div class="single_widgets widget_category">
  ...
  <div class="row">
    <form action="<?php echo e(route('simple.inquiry')); ?>" method="post" class="px-3" id="enquiry-form">
      <?php echo csrf_field(); ?>
      <input type="hidden" name="source" value="Education Malaysia - <?php echo e($source); ?>">
...
<?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\front\forms\simple-form.blade.php ENDPATH**/ ?>