        ...
        <div class="col-12">
          <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">
              <?php echo e($page_title); ?> <span class="text-danger">
                (<?php echo e($examtab->getExam->exam_name); ?> - <?php echo e($examtab->tab_name); ?>)
              </span>
            </h4>
          ...
          <div class="card">
            ...
            <div class="card-body <?php echo e($ft == 'edit' ? '' : 'hide-thi'); ?>" id="tblCDiv">
              <form id="<?php echo e($ft == 'add' ? 'dataForm' : 'editForm'); ?>" <?php echo e($ft == 'edit' ? 'action=' . $url : ''); ?>
                ...
                <?php echo csrf_field(); ?>
                <input type="hidden" name="tab_id" id="tab_id" value="<?php echo e($examtab->id); ?>">
                <div class="row">
...
<?php $component = App\View\Components\SelectField::resolve(['label' => 'Parent Heading','name' => 'parent_id','id' => 'parent_id','savev' => 'id','showv' => 'heading','list' => $rows,'ft' => $ft,'sd' => $sd] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
  ...
  <script>
    ...
    function getData(page) {
      ...
      var tab_id = '<?php echo e($examtab->id); ?>';
      //alert(page+tab_id);
    ...
    function getHeadings() {
      ...
      return new Promise(function(resolve, reject) {
        setTimeout(() => {
          $.ajax({
            url: "<?php echo e(aurl($page_route . '/get-headings')); ?>",
            method: "GET",
            data: {
              tab_id: tab_id,
            },
...
<?php echo $__env->make('admin.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\admin\exam-page-tab-contents.blade.php ENDPATH**/ ?>