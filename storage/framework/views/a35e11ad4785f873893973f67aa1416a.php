            ...
            <div class="log_wraps booking">
              <div class="row  align-items-center">
                <div class="col-lg-12">
                  ...
                  <div class="mcod">Thank You <?php echo e($student->name); ?> for contact us. We will contact you very soon.</div>
                </div>
                <div class="col-lg-12">
...
<?php echo $__env->make('front.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\front\book-demo-thank-you.blade.php ENDPATH**/ ?>