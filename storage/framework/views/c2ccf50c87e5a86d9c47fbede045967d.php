          ...
          <tr>
            <td valign="top" class="content" style="background:white;padding:20px 35px 10px 35px;">
              ...
              <p>If you have any urgent questions or need further assistance, feel free to reply to this email or
                contact us at <strong><a href="tel:<?php echo e(callPhoneNumber(phone_india)); ?>"><?php echo e(phone_india); ?></a></strong>.
              </p>
              <p>We appreciate your interest and look forward to assisting you soon!</p>
              <br>
              <p>Best regards,</p>
              <p><strong><?php echo e(config('app.name')); ?></strong></p>
              <p><strong><?php echo e(contact_email); ?></strong></p>
              <p><a href="<?php echo e(url('/')); ?>"><?php echo e(DOMAIN); ?></a></p>
              <hr>
...
<?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\mails\inquiry-reply.blade.php ENDPATH**/ ?>