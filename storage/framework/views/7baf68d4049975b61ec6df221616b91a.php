          ...
          <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
              <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item"><a href="<?php echo e(url('/admin/course-category')); ?>">Course Categories</a></li>
          ...
          <div class="card">
            ...
            <div class="card-body" id="tblCDiv">
              <form id="<?php echo e($ft == 'add' ? 'dataForm' : 'editForm'); ?>" <?php echo e($ft == 'edit' ? 'action=' . $url : ''); ?>
                ...
                <?php echo csrf_field(); ?>
                <input type="hidden" name="course_category_id" value="<?php echo e($course_category_id); ?>">
                <div class="row">
...
<?php $component = App\View\Components\InputField::resolve(['type' => 'text','label' => 'Enter Question','name' => 'question','id' => 'question','ft' => $ft,'sd' => $sd] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = App\View\Components\TextareaField::resolve(['label' => 'Enter Answer','name' => 'answer','id' => 'answer','ft' => $ft,'sd' => $sd] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
  ...
  <script>
    ...
    function getData(page) {
      ...
      var course_category_id = '<?php echo e($course_category_id); ?>';
...
<?php echo $__env->make('admin.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\reactwithlaravel.educationmalaysia.in\resources\views\admin\course-category-faqs.blade.php ENDPATH**/ ?>